...
const Navbar = () => (
  ...
  >
    ...
    <div className={`${styles.innerWidth} mx-auto flex justify-between items-center gap-8 z-50`}>
      <img src="/search.svg" alt="search" className="relative object-contain w-6 h-6 cursor-pointer" />
      <h1 className="relative text-2xl font-extrabold leading-8 text-white uppercase">Metaexpo</h1>
